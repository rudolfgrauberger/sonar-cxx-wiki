The plugin has three very universal checks to create custom rules. For all rules an optional Ant-style matching pattern (matchFilePattern) for the path can be defined.
...
The proper SSLR Toolkit can be downloaded from here.
